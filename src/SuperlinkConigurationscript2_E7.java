...
public class SuperlinkConigurationscript2_E7 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String qa2 = "https://ol9qa2-angular-gms.ivycomptech.co.in/login";
		...
		String Stress5 = "http://stress5-angular-gms.ivycomptech.co.in/login";
				
		driver.get(E7);

		driver.findElement(By.xpath("//input[@type='text']")).sendKeys(E7username);

		driver.findElement(By.xpath("//input[@type='password']")).sendKeys(E7password);
