...
public class TournamentsconfigcreationE7latest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String Roomname = "BingoTournament01";
		...
		String FreeBingoTourneyCode = "BINGOTOURNAMENTONEONE";

		String FreeBingoTourneyTicketCode = "100";

		// QA2
		//driver.get(
				//"https://S.C.crmdevenduser:W!ndows@234@https://in1vef1vir240.ivycomptech.co.in:8443/siteminderagent/nocert/1711035934/smgetcred.scc?TYPE=16777217&REALM=-SM-BackOffice2--DEV%20[11%3a45%3a34%3a3058]&SMAUTHREASON=0&METHOD=GET&SMAGENTNAME=-SM-sl24r0UOWoFhodiYLsiqLk52TkWKC%2f4XLizXbF5UdHjL7cPbFZw2bqBu9GXgizPY&TARGET=-SM-http%3a%2f%2fbackoffice--e7%2eivycomptech%2eco%2ein%2f");

		// E7
		 driver.get("https://S.C.crmdevenduser:DSous$98923@in1vef1vir240.ivycomptech.co.in:8443/siteminderagent/nocert/1699459000/smgetcred.scc?TYPE=16777217&REALM=-SM-BackOffice2--DEV%20[10%3a56%3a40%3a140011638887359]&SMAUTHREASON=0&METHOD=GET&SMAGENTNAME=-SM-sl24r0UOWoFhodiYLsiqLk52TkWKC%2f4XLizXbF5UdHjL7cPbFZw2bqBu9GXgizPY&TARGET=-SM-http%3a%2f%2fbackoffice--e7%2eivycomptech%2eco%2ein%2f");
		...
		driver.findElement(By.xpath("//div[@id='Campaign Category-panel']//span[normalize-space()='Headline Offer']")).click();
		...
		//When Promo has to start at future time just uncomment the below line
		//roundedDateTime = currentDateTime.plusHours(9).withMinute(roundedMinute);
		...
		LocalDateTime enddateTime = currentDateTime.plusHours(100);
		...
		driver.findElement(By.xpath("//span/span[normalize-space()='USD']")).click();

		//driver.findElement(By.cssSelector(".mat-select-arrow")).click();
		
		//driver.findElement(By.xpath("//div[@id='mat-select-value-29']/following-sibling::div")).click();
		...
		driver.findElement(By.xpath("//input[@id='Max Tickets']"))
		...
		for (int Timer = 0; Timer < 10; Timer++) {
			...
			//Hours.add(roundedDateTime.plusHours(6).getHour());
			
			//Mins.add(roundedDateTime.getMinute());
			
			//Mins.add(roundedDateTime.plusHours(8));
			
			// incrementing time by 15 mins for next iteration
			roundedDateTime = roundedDateTime.plus(60, ChronoUnit.MINUTES);
	...
	//	driver.findElement(By.xpath("//div[@class='scFlexContent']/textarea")).click();
		...
		driver.get(
				"https://S.C.crmdevsuperuser:Ejoshk$8977@in1vef1vir240.ivycomptech.co.in:8443/siteminderagent/nocert/1699459000/smgetcred.scc?TYPE=16777217&REALM=-SM-BackOffice2--DEV%20[10%3a56%3a40%3a140011638887359]&SMAUTHREASON=0&METHOD=GET&SMAGENTNAME=-SM-sl24r0UOWoFhodiYLsiqLk52TkWKC%2f4XLizXbF5UdHjL7cPbFZw2bqBu9GXgizPY&TARGET=-SM-http%3a%2f%2fbackoffice--e7%2eivycomptech%2eco%2ein%2f");
