...
public class Tournamentsconfigcreation_E7 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String FreeBingoTourneyTicketCode = "120";
		...
		driver.findElement(By.xpath("//p[contains(text(),'Free Bingo Tournaments')]")).click();
